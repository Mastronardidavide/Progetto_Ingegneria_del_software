...
class Zona:
    def __init__(self, id: int, nome: str, sogliaZona: float, orarioZona: datetime ):# mi da errore su datedime mi dice di definirlo datetime any, ho messo scome str dettato da gemini
        self._id = id
        self._nome = nome
...
#definisco i getter
    ...
    #definisco il dunder per stampare le variabili, dice che è opzionale e serve per passare un determinato valore, io lo metto per sicurezza poi da valutare se si deve togliere
